...
import { getInterviewHistory, getOverview , getScoreProgress, getRolePerformance, getFeedback} from "../controllers/analyticsController.js";
...
analyticsRouter.get("/feedback",authMiddleware,getFeedback)
