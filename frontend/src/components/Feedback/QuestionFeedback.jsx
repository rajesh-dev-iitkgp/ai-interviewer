...
const QuestionFeedback = ({totalQuestions,currentQuestion,currentQuestionIndex,setCurrentQuestionIndex}) => {
  ...
  return (
    <div className="flex flex-col gap-6 p-4 bg-white col-span-5 w-full rounded-2xl border border-gray-200 shadow-sm">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex justify-between gap-10">
            ...
            {/* Score */}
            <div className="min-w-35 flex flex-col items-end gap-3">
